...
<InfoTab>
    ...
    Image:
        source: "images/2BarG_emblem.png"
...
<ParametersTab>
    ...
    HoverTextButton:
        ...
        on_release: app.select_data_file("incid")
    ...
    HoverTextButton:
        ...
        on_enter:   self.text_color = app.main_color
        on_leave:   self.text_color = "#808080"
        on_release: app.select_data_file("trans")
    ...
    HoverTextButton:
        ...
        on_enter:   self.text_color = app.main_color
        on_leave:   self.text_color = "#808080"
        on_release: app.select_data_file("IR_EXP")
    ...
    HoverTextButton:
        ...
        on_enter:   self.text_color = app.main_color
        on_leave:   self.text_color = "#808080"
        on_release: app.select_data_file("IR_CAL")
    ...
    HoverTextButton:
        ...
        on_enter:   self.text_color = app.main_color
        on_leave:   self.text_color = "#808080"
        on_release: app.select_data_file("TC_CAL")
...
<SettingsTab>
    ...
    MDSwitch:
        ...
        on_active:  app.change_thermal_analysis()
        on_state:   app.change_thermal_analysis()
